...
This repository does **not** contain any game assets or assembly whatsoever. An existing copy of the kernel is required.
...
- Configure:
  ...
  ~~To use a version other than `21256.18_D`, specify it with `--version`.~~ (not a thing currently)
